            ...
            >
              ...
              <div className="absolute top-4 right-4 z-10">
                <span className={`px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm ${
                  project.status === 'Live' || project.status === 'Complete' ? 'bg-green-500/30 text-green-200 border border-green-500/50' :
              ...
              <div className="relative z-10 h-full flex flex-col justify-between p-6">
                {/* Title at Top */}
                <div>
                  <GlassHeading level={2} className="from-white! to-gray-300! group-hover:text-blue-300 transition-colors mb-2">
                    {project.title}
                  </GlassHeading>
