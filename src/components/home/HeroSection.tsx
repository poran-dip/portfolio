...
const HeroCard = () => {
	...
	return (
		<div className="relative min-h-screen w-full overflow-hidden">
			...
			<GlassCard
				hoverable={false}
				className={`relative z-10 min-h-screen flex items-center justify-center p-4 md:p-8 pt-24 md:pt-8 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
			>
					...
					<div className="flex flex-col lg:grid lg:grid-cols-3 lg:gap-12 items-center space-y-8 lg:space-y-0">
						...
						<div className="w-full flex justify-center lg:col-span-1 lg:justify-end">
							<div className="relative group">
								...
								{/* Floating emoji */}
								<div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 text-2xl sm:text-4xl animate-bounce">
									🎵
								</div>
								<div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 text-2xl sm:text-4xl animate-pulse">
									✨
								</div>
							</div>
						</div>
						...
						<div className="w-full lg:col-span-2 space-y-6 lg:space-y-8 text-center lg:text-left px-4 lg:px-0">
							...
							<div className="space-y-4 lg:space-y-6 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto lg:mx-0">
								<p className="opacity-90 hover:opacity-100 transition-opacity duration-300">
									I make pixels dance and sound waves sing 🎶 – crafting digital
									experiences that blur the line between art and code.
								</p>
								...
								<p className="opacity-80 hover:opacity-100 transition-opacity duration-300 text-lg sm:text-xl font-medium">
									Welcome to my corner of the internet – wipe your feet, grab a
									snack, and vibe ✨
								</p>
							</div>
							...
							<div className="flex flex-col sm:flex-row lg:flex-row gap-4 sm:gap-6 justify-center lg:justify-start pt-6 lg:pt-8 w-full">
								...
								<GlassLink href="#contact" variant="internal">
									<GlassButton
										variant="success"
										className="w-full sm:w-48 lg:w-64 h-12 lg:h-14 text-base lg:text-lg font-semibold hover:scale-105 transition-all duration-300 relative overflow-hidden group"
									>
