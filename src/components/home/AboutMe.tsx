        ...
        <div className="mt-6 flex flex-col gap-12">
          ...
          <div className="mt-2 relative">
            ...
            <GlassParagraph className="mt-4">
              ...
              Assam, living my best life building pixel-perfect web apps,
              dropping hard-hitting EDM tracks, and crafting immersive gaming
              experiences. I'm all about that sweet spot where creativity meets
              code.
            </GlassParagraph>
          </div>
            ...
            <div className="mt-6 grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
              ...
              <GlassCard className="p-4 md:p-5 flex flex-col gap-3 from-violet-400/80! to-blue-500/80!">
                ...
                <GlassParagraph className="text-indigo-50!">
                  TypeScript, Python · React, Next.js, TailwindCSS, React
                  Router, Vite · Node.js, Express, Socket.IO, Flask ·
                  PostgreSQL, Prisma
                </GlassParagraph>
              </GlassCard>
            ...
            <div className="mt-6 grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
              ...
              <GlassCard className="p-4 md:p-5 flex flex-col gap-3 from-teal-500/60! to-sky-600/60!">
                ...
                <GlassParagraph className="text-cyan-50!">
                  ...
                  . If I was an isekai MC, I'd wish to reincarnate as an
                  axolotl.
                </GlassParagraph>
              </GlassCard>
