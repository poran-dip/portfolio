...
import { glass, glassAnimations } from "@/styles/glass";
  ...
  return (
    <div
      className={cn(
        glass.base,
        glass.hover,
        "fixed top-4 right-4 p-4 rounded-xl shadow-lg bg-linear-to-r transform transition-all duration-300 z-50 max-w-sm",
